...
namespace WebApplication6.Controllers
{
    public class UczenController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surename,Ulica,PostalCode,City,BirthDate,UczenUserId")] Uczen uczen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surename,Ulica,PostalCode,City,BirthDate,UczenUserId")] Uczen uczen)
        {
            if (id != uczen.Id)
            {
                return NotFound();
